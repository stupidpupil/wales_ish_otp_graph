-- Car profile
-- Based on https://github.com/Project-OSRM/osrm-backend/blob/dca35dcc8676df6fa93f491a7b157136918173d5/profiles/car.lua
...
function setup()
  return {
    ...
    -- average traffic speeds for between 7 and 10am
    -- and https://wiki.openstreetmap.org/w/index.php?title=Roads_in_the_United_Kingdom&oldid=2171135
    -- Links divided by 2
    speeds = Sequence {
      highway = {
        motorway        = 77.6,
        ...
        -- OSM Wiki: Busy unclassified through roads
        -- DfT: Minor road
        tertiary        = 36.3,
        tertiary_link   = 18.2,

        -- OSM Wiki: Other non-residential roads in towns
        -- DfT: Local street
        unclassified    = 18.3,
        ...
        -- DfT: Private road - restricted actress
        service         = 15.3
      }
    },
